...
- [x] 1.8 Parse only complete GitHub remote forms before reading parked-work records; verify a lookalike host is ignored.
...
- [x] 2.4 Determine current-worktree state from the process directory, not the inspection target; verify cleanup cannot remove the shell's worktree.
